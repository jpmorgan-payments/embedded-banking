...
import type { schemas_TransactionRecipientAddress } from './schemas_TransactionRecipientAddress';

export type schemas_TransactionRecipientPartyDetail = {
    /**
     * Address details for the recipient
 * Mandatory for RTP and WIRE payment types
 * 
     */
    address?: schemas_TransactionRecipientAddress;
    type?: PartyType;
    /**
